    ...
    public class RepKickOffProductDeliveryDetailController : Controller
    {
        ...
        public ActionResult deliveryDetail(String deliveryId, List<PrintDeliveryObjectList> deliveryObjectList)
        {
            if (deliveryId != null)
            {
                ...
                Font fontArial12White = FontFactory.GetFont(BaseFont.TIMES_ROMAN, 12, BaseColor.WHITE);
                ...
                quotationDetailLineHeader.AddCell(new PdfPCell(new Phrase(quote + "Innovative and Practical Technology Solutions that fits your business and budget needs." + quote, fontArial12ITALIC)) { Border = 0, PaddingBottom = 6f, HorizontalAlignment = 1 });
                quotationDetailLineHeader.AddCell(new PdfPCell(new Phrase("")) { Border = 1 });
                ...
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Innosoft Form No.: " + deliveryObjectList.FirstOrDefault().ISFormNumber + " (Kick-off Meeting Document)", fontArial12White)) { Colspan = 4, PaddingTop = 10f, PaddingBottom = 12f, PaddingLeft = 5f, PaddingRight = 5f, HorizontalAlignment = 1, BackgroundColor = headerTableColorHeader });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Document No.: " + deliveryObjectList.FirstOrDefault().DocumentNumber, fontArial12)) { PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Date: " + deliveryObjectList.FirstOrDefault().KickOffDeliveryDate, fontArial12)) { PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Prepared By: " + deliveryObjectList.FirstOrDefault().PreparedByUser, fontArial12)) { Colspan = 2, PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Customer: " + deliveryObjectList.FirstOrDefault().Customer, fontArial12)) { Colspan = 2, PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Phone No.: " + deliveryObjectList.FirstOrDefault().CustomerPhoneNumber, fontArial12)) { Colspan = 2, PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Address: " + deliveryObjectList.FirstOrDefault().CustomerAddress, fontArial12)) { Colspan = 4, PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Contact Person: " + deliveryObjectList.FirstOrDefault().ContactPerson, fontArial12)) { Colspan = 2, PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Phone No.: " + deliveryObjectList.FirstOrDefault().ContactPersonPhoneNumber, fontArial12)) { Colspan = 2, PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });
                ...
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Product/Service: " + String.Join(",", productListArray), fontArial12)) { Colspan = 4, PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Particulars: " + deliveryObjectList.FirstOrDefault().Particulars, fontArial12)) { Colspan = 4, PaddingTop = 7f, PaddingBottom = 9f, PaddingLeft = 5f, PaddingRight = 5f, FixedHeight = 70f });
                ...
                checkListTableData.AddCell(new PdfPCell(new Phrase("Checklist: ", fontArial12)) { Colspan = 2, Border = 0, PaddingTop = 4f, PaddingBottom = 6f, PaddingLeft = 5f, PaddingRight = 5f });
                ...
                foreach (var checklistvalue in deliveryObjectList.FirstOrDefault().CheckLists)
                {
                    ...
                    checkListTableData.AddCell(new PdfPCell(new Phrase(checklistvalue.CheckListDescription, fontArial12)) { Border = 0, PaddingTop = 4f, PaddingBottom = 4f, PaddingLeft = 2f, PaddingRight = 5f });
                }
                ...
                termsListData.AddCell(new PdfPCell(new Phrase("Terms: ", fontArial12)) { Colspan = 2, Border = 0, PaddingTop = 2f, PaddingBottom = 4f, PaddingLeft = 5f, PaddingRight = 5f });
                termsListData.AddCell(new PdfPCell(new Phrase("•", fontArial12)) { HorizontalAlignment = 2, Border = 0, PaddingTop = 2f, PaddingBottom = 4f, PaddingLeft = 5f, PaddingRight = 5f });
                termsListData.AddCell(new PdfPCell(new Phrase("This is to certify that the project has been handed over to Operation for implementation and delivery.  The customer now may contact " + deliveryObjectList.FirstOrDefault().FunctionalUser + " of Operation for any question related to the project.", fontArial12)) { Border = 0, PaddingTop = 2f, PaddingBottom = 4f, PaddingLeft = 5f, PaddingRight = 5f });
                termsListData.AddCell(new PdfPCell(new Phrase("•", fontArial12)) { HorizontalAlignment = 2, Border = 0, PaddingTop = 2f, PaddingBottom = 4f, PaddingLeft = 5f, PaddingRight = 5f });
                termsListData.AddCell(new PdfPCell(new Phrase("The one to sign this document will be the signatory of the Software Acceptance Document as well.", fontArial12)) { Border = 0, PaddingTop = 2f, PaddingBottom = 4f, PaddingLeft = 5f, PaddingRight = 5f });
                ...
                salesUserListDataTable.AddCell(new PdfPCell(new Phrase("Sales: ", fontArial12)) { Colspan = 2, Border = 0, PaddingTop = 4f, PaddingBottom = 50f, PaddingLeft = 5f, PaddingRight = 5f });
                salesUserListDataTable.AddCell(new PdfPCell(new Phrase(deliveryObjectList.FirstOrDefault().SalesUser, fontArial12)) { HorizontalAlignment = 1, Border = 0, PaddingTop = 2f, PaddingBottom = 4f, PaddingLeft = 5f, PaddingRight = 5f });
                ...
                functionalUserListDataTable.AddCell(new PdfPCell(new Phrase("Functional: ", fontArial12)) { Colspan = 2, Border = 0, PaddingTop = 4f, PaddingBottom = 50f, PaddingLeft = 5f, PaddingRight = 5f });
                functionalUserListDataTable.AddCell(new PdfPCell(new Phrase(deliveryObjectList.FirstOrDefault().FunctionalUser, fontArial12)) { HorizontalAlignment = 1, Border = 0, PaddingTop = 2f, PaddingBottom = 4f, PaddingLeft = 5f, PaddingRight = 5f });
                ...
                technicalUserListDataTable.AddCell(new PdfPCell(new Phrase("Technical: ", fontArial12)) { Colspan = 2, Border = 0, PaddingTop = 4f, PaddingBottom = 50f, PaddingLeft = 5f, PaddingRight = 5f });
                technicalUserListDataTable.AddCell(new PdfPCell(new Phrase(deliveryObjectList.FirstOrDefault().TechnicalUser, fontArial12)) { HorizontalAlignment = 1, Border = 0, PaddingTop = 2f, PaddingBottom = 4f, PaddingLeft = 5f, PaddingRight = 5f });
                ...
                customerUserListDataTable.AddCell(new PdfPCell(new Phrase("Customer: ", fontArial12)) { Colspan = 2, Border = 0, PaddingTop = 4f, PaddingBottom = 50f, PaddingLeft = 5f, PaddingRight = 5f });
                customerUserListDataTable.AddCell(new PdfPCell(new Phrase(deliveryObjectList.FirstOrDefault().CustomerUser, fontArial12)) { HorizontalAlignment = 1, Border = 0, PaddingTop = 2f, PaddingBottom = 4f, PaddingLeft = 5f, PaddingRight = 5f });
                ...
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Signed over printed name", fontArial12)) { HorizontalAlignment = 1, PaddingTop = 2f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Signed over printed name", fontArial12)) { HorizontalAlignment = 1, PaddingTop = 2f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Signed over printed name", fontArial12)) { HorizontalAlignment = 1, PaddingTop = 2f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
                kickOffDeliveryDataTable.AddCell(new PdfPCell(new Phrase("Signed over printed name", fontArial12)) { HorizontalAlignment = 1, PaddingTop = 2f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f });
